...
"""
    ...
    Requires: psutil
    Shows a bar graph of space used for each drive particion that psutil finds
    Copyright 2022 PySimpleGUI
"""

ALPHA = 0.7
THEME = 'black' #its the theme universal 
...
def create_window(location):
    layout = [[sg.Text('X', enable_events=True, font='Any 16'), sg.Text('Drive Status', font='Any 16')]]
...
def main(location):
    ...
    try:
        ...
        while True:
            ...
            if event in (sg.WIN_CLOSED, sg.WIN_CLOSE_ATTEMPTED_EVENT, 'Exit', 'X'):
